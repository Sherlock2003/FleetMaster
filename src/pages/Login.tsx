          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center py-3 px-4 rounded-xl shadow-sm bg-white text-sm font-medium text-slate-900 hover:bg-slate-100 transition-colors"
              >
